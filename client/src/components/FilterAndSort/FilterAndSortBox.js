...
const FilterSortBox = () => {
 ...
 useEffect(() => {
  ...
  const generateFilterString = () => {
    ...
    console.log('seefilters: ', filters);
...
if (tempFilters.minAgeLimit && parseInt(tempFilters.minAgeLimit) > user.age) {
  ...
  return; // Stop applying filters
    ...
    //   searchParams.append('genres', filters.genres.join(','));
    // }
    // if (filters.minAgeLimit) {
    //   searchParams.append('minAgeLimit', filters.minAgeLimit);
    // }
    // if (filters.releaseYear) {
    //   searchParams.append('releaseYear', filters.releaseYear);
    // }
